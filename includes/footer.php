  ...
  <div class="footer-inner">
    <div class="footer-grid">
      <div class="footer-brand-col">
        <a class="footer-brand" href="/PGLIFE/index.php">
          <img src="/PGLIFE/img/logo.png" alt="PG Life" class="footer-logo" />
          <!-- <span>PG<span>Life</span></span> -->
        </a>
      ...
      <div class="footer-links-col">
        <h6>Explore</h6>
        <a href="/PGLIFE/index.php">Home</a>
        <a href="/PGLIFE/about.php">About Us</a>
        <a href="/PGLIFE/contact.php">Contact</a>
        <a href="/PGLIFE/property_list.php?city=Delhi">Browse PGs</a>
      </div>
      <div class="footer-links-col">
